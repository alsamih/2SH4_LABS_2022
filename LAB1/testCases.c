...
*/
    ...
    void TestQ3_invalid_3(CuTest *tc) {
...
//=================Question 6================================   
    ...
    void TestQ6_100(CuTest *tc) {
            int input = 100;
            int expected[100]={6,24,28};
            int actual[100];
            int expectedCount = 3;
            int actualCount = Q6(input,actual);
            CuAssertIntEquals(tc, expectedCount, actualCount);
...
//=================Question 7================================  
    ...
    void TestQ7b_3(CuTest *tc) {
            int input = 8987675453;
            int actual = Q7b(input);
            int expected = 3545767898;
            CuAssertIntEquals(tc, expected, actual);
        }
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_decimal);
        ...
        SUITE_ADD_TEST(suite, TestQ3_invalid_3);
        ...
        SUITE_ADD_TEST(suite, TestQ6_100);
