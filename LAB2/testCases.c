...
void TestQ1_add_2(CuTest *tc) {
	...
	int n = 6;
	double input1[6] = {7,6,5,4,8,2};
	double input2[6] = {9,0,8,7,6,5};
	double actual[6];
	double expected [6] = {16,6,13,11,14,7};
	add_vectors(input1,input2,actual,n);
	int i;
	for (i=0; i<n; i++)
		CuAssertDblEquals(tc, expected[i], actual[i],0.009);
...
void TestQ1_scalar_prod_2(CuTest *tc) {
	...
	int n = 3;
	double input1[3] = {5,8,2};
	double input2[3] = {9,7,8};
	double expected=117 ;
	double actual = scalar_prod(input1,input2,n);
...
void TestQ2_false_2(CuTest *tc) {

		int input[3][3] = {{60, 20, 5}, {25, 8, 0}, {25, 2, 9}};
		int actual = is_diag_dom(input);
		int expected = 0;
		CuAssertIntEquals(tc, expected, actual);
}
...
void TestQ3_2(CuTest *tc) {
	int n = 3;
	int input[3][3] = {{4, 2, 2},{ 0, 0, 2},{ 10, 3, 8}};
	int expected[9]= {4,0,2,10,0,2,3,2,8};
	int actual[9];
	diag_scan(input,actual);
...
void TestQ4_alphabet(CuTest *tc) {
...
void TestQ6_2(CuTest *tc) {
	...
	efficient(input,actual_output_val,actual_output_pos,n);
	int expected_output_val[5]={1};
	int expected_output_pos[5]={4};
...
void TestQ7_equalSizeInputs_new_2(CuTest *tc) {
    // HARDCODED testcases
        int input_val1[] = {0,0,0};
        int input_pos1[] = {0,0,0};
        int input_val2[] = {0,0,0};
        int input_pos2[] = {0,0,0};
...
CuSuite* Lab2GetSuite() {
	...
	SUITE_ADD_TEST(suite, TestQ2_false_2);
	...
	SUITE_ADD_TEST(suite, TestQ4_alphabet);
	...
	SUITE_ADD_TEST(suite, TestQ7_equalSizeInputs_new_2);
